...
--
-- Data for Name: car_brand; Type: TABLE DATA; Schema: public; Owner: root
--

INSERT INTO public.car_brand VALUES (1, 'asd', 'asd');


--
-- Data for Name: car_model; Type: TABLE DATA; Schema: public; Owner: root
--

INSERT INTO public.car_model VALUES (1, 'asd', 1, 123);
...
INSERT INTO public.stock VALUES (1, 1, 1, 150, 10);
...
INSERT INTO public.store VALUES (1, 'asd', 'asd');


--
-- Name: car_brand_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--

SELECT pg_catalog.setval('public.car_brand_id_seq', 50, true);


--
-- Name: car_model_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--

SELECT pg_catalog.setval('public.car_model_id_seq', 5, true);
